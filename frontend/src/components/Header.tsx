...
export default function Header() {
    ...
    return (
        <header className="flex w-ful max-[768px]:p-5 h-16 bg-zinc-200 dark:bg-black items-center">
            <p className="text-2xl font-bold max-[768px]:ml-0 ml-15 cursor-pointer" onClick={() => navigate('/')}>Mearn</p>
            <ul className="flex gap-10 ml-65 max-[768px]:hidden">
                <li className="text-lg cursor-pointer transition-all duration-300 hover:scale-95" onClick={() => navigate('/')}>Home</li>
